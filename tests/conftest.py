...
from asyncio import StreamReader, StreamWriter, start_server, ensure_future, sleep
from typing import Awaitable, Optional, Dict, Union, List
...
@pytest.fixture
async def freeswitch():
    host = socket.gethostbyname(socket.gethostname())
    port = 8021  # get_free_tcp_port()
