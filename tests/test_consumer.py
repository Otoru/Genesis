...
async def test_receive_mod_audio_stream_play(freeswitch, mod_audio_stream_play):
    async with freeswitch as server:
        ...
        assert event == {
            ...
            "Channel-Name": "sofia/internal/1000@192.0.2.2",
            "Unique-ID": "84e7dad0-dc1e-4234-8c56-5688e2069d99",
            "Call-Direction": "inbound",
            "Presence-Call-Direction": "inbound",
            "Channel-HIT-Dialplan": "true",
            "Channel-Presence-ID": "1000@192.0.2.2",
            ...
            "Caller-Channel-Name": "sofia/internal/1000@192.0.2.2",
            ...
            "variable_sofia_profile_url": "sip:mod_sofia@192.0.2.4:5060",
            "variable_recovery_profile_name": "internal",
            "variable_sip_full_via": "SIP/2.0/UDP 192.0.2.3:65154;rport=65154;branch=z9hG4bKPjUtX7iY.6-KV2faycxhzseZiQy-KTpp9v",
            "variable_sip_from_display": "1000",
            "variable_sip_full_from": '"1000" <sip:1000@192.0.2.2>;tag=ctd4Q7kZX1X-ymiaOZW75CCNoctiyssB',
            "variable_sip_full_to": "sip:4001@192.0.2.2",
            ...
            "variable_sip_req_uri": "4001@192.0.2.2",
            "variable_sip_req_host": "192.0.2.2",
            "variable_sip_to_user": "4001",
            "variable_sip_to_uri": "4001@192.0.2.2",
            ...
            "variable_sip_contact_uri": "1000@192.0.2.3:65154",
            ...
            "variable_rtp_local_sdp_str": "v=0\r\no=FreeSWITCH 1723807682 1723807683 IN IP4 192.0.2.2\r\ns=FreeSWITCH\r\nc=IN IP4 192.0.2.2\r\nt=0 0\r\nm=audio 19072 RTP/AVP 96 101\r\na=rtpmap:96 opus/48000/2\r\na=fmtp:96 useinbandfec=1\r\na=rtpmap:101 telephone-event/48000\r\na=fmtp:101 0-15\r\na=ptime:20\r\na=sendrecv\r\na=rtcp:19073 IN IP4 192.0.2.2\r\n",
